...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('wholesome/footnote-list', {
  ...
  edit: () => {
    ...
    if (!footnotes.length) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("aside", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Please add a footnote.')));
    }
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("aside", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
      ...
      const backLink = ` <a class="wholesome-footnote-list__item-back" href="#${note.uid}" ` + `aria-label="${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Back to content')}" title="${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Back to content')}">` + `↵</a>`;
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
        className: "wholesome-footnote-list__item" // eslint-disable-next-line react/no-danger
        ,
...
const setFootnoteNumbers = () => {
  ...
  const footnotes = (meta === null || meta === void 0 ? void 0 : meta.wholesome_footnotes) || [];
  const uidOrder = {};
  ...
  const newFootnotes = [...footnotes.filter(({
    uid
  }) => existingBlocks.includes(uid))];
